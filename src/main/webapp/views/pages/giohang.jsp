...
<div id="checkout-cart" class="container">
    <ul class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="../../views/pages/index.jsp"><i class="fas fa-home"> </i></a>
        </li>
        <li class="breadcrumb-item">
            <a href="../../views/pages/giohang.jsp">Giỏ hàng</a>
        </li>
    </ul>
        ...
        <div id="content" class="col mt-5">
            ...
            <div class="d-inline-block pt-2 pd-2 w-100">
                <div class="float-start">
                    <a href="../../views/pages/index.jsp" class="btn btn-light">Tiếp tục mua sắm</a>
                </div>
                <div class="float-end">
                    <a href="../../views/pages/thanh-toan.jsp" class="btn btn-primary" id="checkoutButton">Thanh toán</a>
                </div>
            </div>
        </div>
    </div>
