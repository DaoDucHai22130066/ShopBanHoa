    ...
    <div id="banner-carousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/Carousel/carousel1.webp" class="d-block w-100 banner" alt="Banner Quảng Cáo 1" />
            </div>
            <div class="carousel-item">
                <img src="img/Carousel/carousel2.webp" class="d-block w-100 banner" alt="Banner Quảng Cáo 2" />
            </div>
            <div class="carousel-item">
                <img src="img/Carousel/carousel3.webp" class="d-block w-100 banner" alt="Banner Quảng Cáo 3" />
            </div>
            <div class="carousel-item">
                <img src="img/Carousel/carousel2.webp" class="d-block w-100 banner" alt="Banner Quảng Cáo 4" />
            </div>
            <div class="carousel-item">
                <img src="img/Carousel/carousel1.webp" class="d-block w-100 banner" alt="Banner Quảng Cáo 5" />
            </div>
        </div>
